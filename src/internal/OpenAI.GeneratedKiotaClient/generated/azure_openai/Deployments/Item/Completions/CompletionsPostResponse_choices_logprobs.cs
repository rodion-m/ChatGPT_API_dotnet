...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<CompletionsPostResponse_choices_logprobs_top_logprobs>? TopLogprobs { get; set; }
#nullable restore
#else
        public List<CompletionsPostResponse_choices_logprobs_top_logprobs> TopLogprobs { get; set; }
#endif
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"top_logprobs", n => { TopLogprobs = n.GetCollectionOfObjectValues<CompletionsPostResponse_choices_logprobs_top_logprobs>(CompletionsPostResponse_choices_logprobs_top_logprobs.CreateFromDiscriminatorValue)?.ToList(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<CompletionsPostResponse_choices_logprobs_top_logprobs>("top_logprobs", TopLogprobs);
