...
namespace OpenAI.Azure.GeneratedKiotaClient.Deployments.Item.Chat {
    ...
    internal class ChatRequestBuilder : BaseRequestBuilder {
        ...
        public ChatRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deployments/{deployment%2Did}/chat", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ChatRequestBuilder and sets the default values.
        /// </summary>
