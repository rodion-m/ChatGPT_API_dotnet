...
namespace OpenAI.Azure.GeneratedKiotaClient.Deployments.Item.Chat.Completions {
    ...
    internal class CompletionsRequestBuilder : BaseRequestBuilder {
        ...
        public CompletionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deployments/{deployment%2Did}/chat/completions{?api%2Dversion*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CompletionsRequestBuilder and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        public async Task<CreateChatCompletionResponse> PostAsync(CreateChatCompletionRequest body, Action<CompletionsRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<CreateChatCompletionResponse>(requestInfo, CreateChatCompletionResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Creates a completion for the chat message
        /// </summary>
