...
using System;
namespace OpenAI.GeneratedKiotaClient.Images.Edits {
    /// <summary>
...
#nullable enable
        public async Task<ImagesResponse?> PostAsync(MultipartBody body, Action<EditsRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<ImagesResponse> PostAsync(MultipartBody body, Action<EditsRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(MultipartBody body, Action<EditsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(MultipartBody body, Action<EditsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
