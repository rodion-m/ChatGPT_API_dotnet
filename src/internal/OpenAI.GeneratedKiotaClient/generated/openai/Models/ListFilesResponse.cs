...
namespace OpenAI.GeneratedKiotaClient.Models {
    internal class ListFilesResponse : IAdditionalDataHolder, IParsable {
...
#nullable restore
        ...
        public ListFilesResponse_object? Object { get; set; }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"object", n => { Object = n.GetEnumValue<ListFilesResponse_object>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteEnumValue<ListFilesResponse_object>("object", Object);
