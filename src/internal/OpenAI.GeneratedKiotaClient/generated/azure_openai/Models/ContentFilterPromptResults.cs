...
namespace OpenAI.Azure.GeneratedKiotaClient.Models {
    ...
    /// </summary>
    internal class ContentFilterPromptResults : ContentFilterResultsBase, IParsable {
        /// <summary>The jailbreak property</summary>
...
#nullable restore
        ...
        public static new ContentFilterPromptResults CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ContentFilterPromptResults();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                {"jailbreak", n => { Jailbreak = n.GetObjectValue<ContentFilterDetectedResult>(ContentFilterDetectedResult.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<ContentFilterDetectedResult>("jailbreak", Jailbreak);
        }
    }
}
