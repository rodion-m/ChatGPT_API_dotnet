...
namespace OpenAI.GeneratedKiotaClient.Models {
    internal class ListAssistantFilesResponse : IAdditionalDataHolder, IParsable {
...
#nullable restore
        ...
        public static ListAssistantFilesResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                {"data", n => { Data = n.GetCollectionOfObjectValues<AssistantFileObject>(AssistantFileObject.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<AssistantFileObject>("data", Data);
