...
namespace OpenAI.GeneratedKiotaClient.Models {
    internal class CreateEditResponse_choices : IAdditionalDataHolder, IParsable {
        ...
        public CreateEditResponse_choices_finish_reason? FinishReason { get; set; }
...
#nullable restore
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                {"finish_reason", n => { FinishReason = n.GetEnumValue<CreateEditResponse_choices_finish_reason>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteEnumValue<CreateEditResponse_choices_finish_reason>("finish_reason", FinishReason);
